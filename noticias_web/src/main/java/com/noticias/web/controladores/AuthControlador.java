...
import com.noticias.web.dtos.LoginRespuestaDTO;
import com.noticias.web.dtos.UsuarioDTO;
import com.noticias.web.servicios.AuthServicio;
import com.noticias.web.servicios.LoggerService; // Now exists
...
public class AuthControlador {
    ...
    // The original constructor is removed as field injection is now used.
    ...
    public String login(@RequestParam String email,
        ...
        try {
            ...
            // LOGGING
            try {
                logger.initSessionLog(email);
                logger.logAction(email, "LOGIN", "Login successful. Role: " + usuario.getRolNombre());
            } catch (Exception e) {
            ...
            // LOG ERROR
            try {
                logger.logError("AuthControlador.login - Failed for email: " + email, ex);
